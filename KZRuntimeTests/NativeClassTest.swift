//
//  KZRuntimeTests.swift
//  KZRuntimeTests
//
//  Created by Mike Kasianowicz on 7/7/15.
...
class NativeClassTest: XCTestCase {
    var classInfo: ClassInfo! = nil
    var testObject: TestClass! = nil
    
    override func setUp() {
        super.setUp()
        classInfo = KZRuntime.sharedRuntime.registerType(TestClass.self) as! ClassInfo
        testObject = classInfo.newInstance() as! TestClass
    }
